      ...
      <main className="max-w-2xl mx-auto px-4 py-6 space-y-4">
        {session.status === "trial" && daysLeft <= 3 && (
          <div className="bg-red-50 border border-red-200 rounded-2xl px-4 py-3">
            <p className="text-red-600 font-bold text-sm">
              ⚠️ {daysLeft} दिन में परीक्षण समाप्त होगा।
            </p>
            <a
              href={
                "https://nishantsoftwares.in/sunar?email=" +
        ...
        {session.status === "trial" && daysLeft > 3 && (
          <div className="bg-amber-50 border border-amber-200 rounded-2xl px-4 py-3">
            <p className="text-amber-600 font-semibold text-sm">
              ⏳ {daysLeft} दिन का मुफ्त परीक्षण चल रहा है।
            </p>
          </div>
        )}
        ...
        <div className="grid grid-cols-2 gap-3">
          <Link
            ...
            className="bg-white rounded-2xl p-5 border border-zinc-100 shadow-sm flex flex-col items-center gap-2 hover:border-[#AA7D6E] transition"
          >
